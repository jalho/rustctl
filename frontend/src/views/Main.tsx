          ...
          <table style={{ width: "100%", borderCollapse: "collapse", backgroundColor: "#161b22", border: "1px solid #30363d", borderRadius: "6px", overflow: "hidden", marginBottom: "16px" }}>
            ...
            <tbody>
              {clientEntries.map(([uuid, client]) => (
                <tr key={uuid}>
                  <td style={{ padding: "12px 16px", textAlign: "left", borderBottom: "1px solid #30363d", color: "#8b949e" }}>{client.identity.Anonymous.session_id + formatIsSelf(props.sessionId === client.identity.Anonymous.session_id)}</td>
