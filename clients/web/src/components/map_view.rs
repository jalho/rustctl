...
fn PlayerMarker(
    ...
    rsx! {
        div { style: "{marker_style}", title: "{display_name}",
            ...
            div { style: "position: absolute; top: 16px; left: 50%; transform: translateX(-50%); white-space: nowrap; background: rgba(22, 27, 34, 0.95); color: #e6edf3; padding: 3px 6px; border-radius: 3px; font-size: 10px; font-weight: 500; border: 1px solid #30363d; pointer-events: none;",
                "{display_name}"
            }
        }
    }
